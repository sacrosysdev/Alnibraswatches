...
const TotalOrderChart = () => {
  ...
  }, [lineColor, fillBottomColor, fillTopColor]);
    ...
    <div className="w-full h-[200px] bg-white rounded-lg shadow-md p-5  flex flex-col ">
      ...
      <div className="w-full h-fit flex flex-row gap-x-4">
        ...
        <div className="flex gap-2 w-fit h-fit">
          <span className="capitalize text-sm whitespace-nowrap text-[#546D7D] font-public ">
            Pending Order
          </span>
          <span className="capitalize text-sm whitespace-nowrap text-[#FFCC00] font-public ">
            {6}
          </span>
        </div>
      </div>
