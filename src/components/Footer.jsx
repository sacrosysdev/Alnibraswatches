...
const Footer = () => {
  return (
    <div className='bg-[#A3C4C1] '>
      <div className='grid grid-cols-1 xl:grid-cols-11 gap-5 p-5 xl:p-20'>
        <div className='col-span-2'>
          <img src={Logo} alt="" className='object-contain'/>
        </div>
        {footerData.map((item, index)=>(<div key={index} className='col-span-2 text-[#003F38]'>
        ...
        <h1 className='font-medium text-lg text-[#003F38] text-start xl:text-end'>Questions? Comments? Concerns?</h1>
