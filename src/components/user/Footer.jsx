  ...
  return (
    <div className="bg-[#A3C4C1]">
      <div className="grid grid-cols-1 xl:grid-cols-5 gap-5 p-5 xl:p-20">
            ...
            {!loadingCategories &&
              ...
              categories.map((el, index) => (
                <li
                  ...
                  onClick={() => goCategoryHandler(el.Id)}
                >
                  {el.Name}
                </li>
              ))}
            ...
            <ul className="pt-5 flex flex-col gap-4 text-base">
              {item.subtitles.map((el, subIndex) => (
                <li
                  ...
                  onClick={() => navigationHandler(el.link)}
                >
        ...
        <div className="text-[#003F38]">
          <h1 className="font-medium text-lg text-start xl:text-end">
            Questions? Comments? Concerns?
          </h1>
          <div className="pt-5 flex xl:justify-end">
            <button className="bg-[#003F38] rounded-lg px-5 py-2 text-white transition-all duration-300 ease-in-out hover:bg-[#00211E] hover:shadow-lg hover:scale-105">
              Help
            </button>
          </div>
        </div>
