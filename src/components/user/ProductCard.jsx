...
const ProductCard = ({
  ...
  const displayPrice =
    price !== undefined && price !== null ? price : "Price not available";
  ...
  return (
    <div
      className={`relative flex flex-col items-center gap-4 pb-5
                ...
                ${
                  isOutOfStock
                    ? "bg-gray-100 shadow-md border border-red-200 hover:shadow-lg"
                    : "bg-gray-100 shadow-xl hover:shadow-2xl hover:scale-105 hover:bg-gray-50"
                }`}
    ...
    >
      ...
      <motion.div className="absolute top-4 right-4" whileTap={{ scale: 0.8 }}>
        <img
