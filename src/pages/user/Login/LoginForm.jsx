        ...
        <Formik initialValues={initialValues} validationSchema={loginValidation} onSubmit={handleSubmit}>
            <Form>
                ...
                <div className=' space-y-4'>
                    ...
                    <div className="h-5">
                        <ErrorMessage name="remember" component="div" className="text-red-500 text-sm" />
                    </div>
                    <div className='bg-[#005C53] text-white flex mx-auto w-fit mt-10 rounded-full'>
                        <button type='submit' className='uppercase cursor-pointer py-3 px-10 tracking-wider'>Sign in</button>
                    </div>
                </div>
            </Form>
        </Formik>
