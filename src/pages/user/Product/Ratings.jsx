      ...
      <div className="relative">
        <div className="flex justify-between items-center py-3">
          <div>
            ...
            <p
              className="text-md mt-3 text-blue-600 cursor-pointer hover:text-blue-800 transition-colors"
          ...
          <div className="flex flex-col gap-4">
            <div className="flex gap-2 items-center">
              <h1 className="font-bold text-3xl font-bodoni">0.0</h1>
              <div>
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-gray-600 mt-1">
                Login to see and write reviews for this product
              </p>
            </div>
            <button
              onClick={() => {
              ...
              className="px-4 py-2 bg-[#005C53] text-white text-sm rounded-md hover:bg-[#004A42] transition-colors"
            >
              Login
            </button>
          </div>
  ...
  return (
    <div className="relative">
      <div className="flex justify-between items-center py-3">
        ...
        <div className="flex flex-col gap-4">
          <div className="flex gap-2 items-center">
            <h1 className="font-bold text-3xl font-bodoni">
              {" "}
              {reviews?.reviewCon?.[0]?.AverageRating ?? "0.0"}
            </h1>
            <div>
              <img src={Star} alt="star" />
            </div>
      ...
      {reviewsLoading ? (
        ...
        <div>
          {(showAllReviews
            ...
            : reviews.reviewDetail?.slice(0, 3)
          )?.map((review, index) => (
            <div key={index}>
      ...
      {reviews.reviewDetail?.length > 3 && (
        ...
        >
          <h1 className="text-base font-medium">
            {showAllReviews
              ? "Show less"
              : `See all ${reviews.reviewDetail.length} Reviews`}
          </h1>
          <FaAngleRight
            className={
              showAllReviews
