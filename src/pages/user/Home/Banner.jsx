    ...
    <div className="">
      <div className="relative h-[110vh] md:h-[70vh] xl:min-h-[130vh] overflow-hidden">
        ...
        <div className="absolute left-2 xl:left-16 top-5 xl:top-16 w-full">
          <h1 className="md:w-1/2 font-unlock text-3xl xl:text-[60px] xl:leading-16 text-white">
            Discover the Future of Watch E-Commerce: Unleash Your Style!
          </h1>
          <p className="w-11/12 md:w-1/3 pt-5 font-extralight leading-5 text-white">
        ...
        <div className="absolute bottom-0 py-14 backdrop-blur-md w-full flex xl:gap-10 justify-center items-center">
          <div className="flex absolute bottom-48  md:-bottom-3 lg:-bottom-10 xl:-bottom-10 ">
            <div className="min-h-[70vh]">
              <img src={Watch} alt="" className="object-cover w-full h-full " />
            </div>
          </div>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
            {features.map((item, index) => (
              <div key={index} className="flex flex-col gap-2 items-center ">
                ...
                <h1 className="text-white pt-2  font-extralight tracking-wide">
                  {item.feature1}
                </h1>
                <h1 className="text-[#A5B2BA] text-sm font-extralight">
                  {item.feature2}
                </h1>
              </div>
            ))}
