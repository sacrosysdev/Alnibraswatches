    ...
    <div className="py-10">
      <div className="p-5  md:p-10 border border-[#EBEBEB] rounded-xl flex flex-col gap-10">
        ...
        <div>
          ...
          <div className="flex flex-col gap-5 pt-5">
            ...
            <div className="flex justify-between font-semibold  pt-3">
              <span>Total</span>
              <span>
                AED <span>{subtotal + subtotal * (5 / 100)}</span>
              </span>
            </div>
          </div>
        </div>
        <div className="w-full  ">
          <button
            className="bg-[#00211E] font-bold py-2 w-full rounded-lg
                     text-white cursor-pointer transition-all duration-300 ease-in-out hover:bg-[#001815] hover:shadow-lg hover:scale-105"
