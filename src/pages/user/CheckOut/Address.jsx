...
const Address = ({ label, phone, address, district, userName, city, landmark, onEditClick }) => {
    ...
    return (
        <div className="border border-gray-200 rounded-md p-4 max-w-md bg-white shadow-sm md:w-1/2 w-90" >
            <div className="flex justify-between items-center mb-2">
                ...
                <button className="text-sm text-blue-600 hover:underline font-medium cursor-pointer" onClick={onEditClick}>
                    {isProfilePage ? <FaEdit size={20} /> : <Link to="/profile/manage-address">Manage Address</Link>}
                </button>
            </div>
