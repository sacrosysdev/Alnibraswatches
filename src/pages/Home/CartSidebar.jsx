        ...
        <AnimatePresence>
          ...
          /> */}
                    ...
                    <motion.div
                        ...
                        className="fixed top-0 right-0 w-1/4 h-full bg-[#003F38] shadow-lg z-50 p-5 flex flex-col text-white"
                    >
                        {/* Header */}
                        ...
                        <div className=" mt-4">
                            ...
                            <div className="flex-grow overflow-y-auto h-[50vh] scrollbar-hide py-5">
